...
To me, it doesn't make sense to make **ADAM** in anything *other* than porcelain. Other than architecture, pottery has always been my favorite form of art.  Most hobbyist plastic keyboard prints I've seen turn out looking relatively ugly to me, requiring lots of sanding and painting to make them look professional. The 3D printing process for porcelain makes everything smooth and even, gives it a nice heft and feel, and the way some of the glaze pools and highlights the features of the keyboard looks stunning.[^1]
