...
```{r, fig.cap="The time spans that are 'significant' change wildly depending on the arbitrary wiggles of the smooth. Here, the GAM has the number of basis functions for the time smooth set to 12."}
