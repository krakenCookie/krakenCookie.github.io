...
I love the look, but I sometimes feel that this aesthetic has a somewhat limited imagination. Just because the *technology* is modern doesn't mean an *object* has to look modern. In fact, I think technology has progressed to the point where we can start looking *back* for artistic inspiration. 
...
![Celadon green without the stand-in caps, viewed from the front.]({{ site.url }}/images/adam_ic/green_nokeys_side2.png)
