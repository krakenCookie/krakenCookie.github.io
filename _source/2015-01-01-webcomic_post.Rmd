...
```{r smbc_votey_graph,warning=FALSE,echo=FALSE,fig.width=5}
p <- smbc %>%
...
<p class = "figcaption">Typical height of one panel = 500 px. If you want to make graphs like this in `ggplot`</p>
