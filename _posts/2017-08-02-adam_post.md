...
<p class = "figcaption">This is what will actually be printed (the Let's Split PCB version). The plate will be mounted on the ledges (one of which you can see from this angle), leaving the underside open for access and LEDs.</p>
...
![Celadon green without the stand-in caps, viewed from the side]({{ site.url }}/images/adam_ic/green_nokeys_side.png)

<p class = "figcaption">A side view of what will actually be printed, demonstrating the festoons.</p>
