...
I haven't set prices yet, but each half will be *at least* \$100. If there is a lot of interest, I might be able to work out a deal with the manufacturers (doubtful though), but I'm guessing a full keyboard set (plates included) is going to run for about \$275-\$300.  
...
[^2]: Thanks to Frank M. for taking pictures of Robert Adam, /u/_zsh for getting me detailed measurements of their setup, /u/wootpatoot for providing open-source files for their PCB, and niceinabox for [their helpful Let's Split guide](https://github.com/nicinabox/lets-split-guide/blob/master/assembly.md)
